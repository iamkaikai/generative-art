...
let rRand = randBetween(100,200);
let gRand = randBetween(100,200);
let bRand = randBetween(100,200);
...
if(patternRand<0.2){
	p = 1;
}else if(patternRand>=0.2 && patternRand<0.5){
	p = 2;
}else if(patternRand>=0.5 && patternRand<0.85){
	p = 3;	
